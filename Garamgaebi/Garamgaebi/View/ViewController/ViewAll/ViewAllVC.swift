...
class ViewAllVC: UIViewController {
    ...
    @objc func pushEventDetailVC() {
        self.navigationController?.pushViewController(EventSeminarDetailVC(memberId: 1, seminarId: 6), animated: true)
//        self.navigationController?.pushViewController(EventNetworkingDetailVC(memberId: 1, networkingId: 1), animated: true)
    }
