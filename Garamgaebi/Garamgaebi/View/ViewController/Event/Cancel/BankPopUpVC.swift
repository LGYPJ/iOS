...
class BankPopUpVC: UIViewController {
...
extension BankPopUpVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
